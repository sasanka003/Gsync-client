    ...
    <div className="lg:w-[715px] md:w-[664px] mx-auto p-4">
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="text-LM underline text-text">Forgot Password?</div></div>
          <div>
            <Button
              type="submit"
      ...
      <div className="mt-8 text-center">
        ...
        <div className="flex justify-center space-x-6 mt-2">
          <button className="flex items-center px-4 py-2 bg-fill rounded text-suble-semibold lg:w-[220px] gap-2 text-common">
            <img
          ...
          <button className="flex items-center px-4 py-2 bg-common rounded text-fill text-suble-semibold lg:w-[220px] gap-2 text-common">
            <img
